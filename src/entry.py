...
async def on_fetch(request, env):
    ...
    if url.path.startswith("/transbank") and method == 'GET':
        ...
        repair_url = f"https://repair_alectrico.alectrico.cl/go_tbk?pago_url={pago_url}&token_ws={token}"
...
<section class="footer1 cid-sezOMgUKyB" once="footers" data-bg-video={env.VIDEO_URL} id="footer1-f">
