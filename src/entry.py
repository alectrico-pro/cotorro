...
<div class='offset-md-3 col-md-6'>
        ...
        <div class='mbr-section-btn mt-3'><a class='btn btn-primary display-4' href= "https://api.whatsapp.com/send?phone={env.PUBLICO_COLABORADOR}"> <span class='socicon socicon-whatsapp mbr-iconfont mbr-iconfont-btn'></span></a> 
