...
<body>
  ...
  <section class='mbr-section form4 cid-qAUteatZnl' id='form4-8e' style='border-top-style: solid;border-top-width: 0px;right: -;margin-bottom: 10px;margin-top: 10px;' >
    <div class='container'>
      ...
      <div class='row'>
        <div class='offset-md-3 col-md-6'>
          <div>
              ...
              <div class='col-md-10' multi-horizontal data-for='amount'>
