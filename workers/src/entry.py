               ...
               if await es_colaborador(env, wa_id):
                    ...
                    if descripcion == "No":
                      ...
                      if k == 0:
                        ...
                        await env.DIALOGO.put( str(fono) + str(datetime.datetime.now()) + ":gerente" ,     mensaje_inicial )
                        await env.DIALOGO.put( str(fono) + str(datetime.datetime.now()) +":electricista" , mensaje_colaborador )
                        ...
                        await env.DIALOGO.put( str(fono) + str(datetime.datetime.now()) +":gerente", mensaje_gerente )
